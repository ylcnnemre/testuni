                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td width="60%" class="mobile-stack mobile-center">
                                        <h1 style="margin: 0; font-size: 30px; color: white;">You've Created Your
                                            Application!</h1>
                                    </td>
                                    <td width="40%" align="right" class="mobile-stack mobile-center">
                                        <img src="https://test.kodafor.com/rubikcube.png" alt="Security Icon"
                    ...
                    <tr>
                        <td class="content-cell" style="padding: 30px;">
                            ...
                            <p style="color: black;">
                                ...
                                sapien tristique eros porta sodales
                            </p>
